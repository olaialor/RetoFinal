...
public class LogIn extends JFrame implements ActionListener {
	...
	public LogIn(Controlador c, Usuario u) {
		this.l=c;
		this.user=u;
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == btnSignUp) {
			...
			LogIn.this.dispose();
			try {
				SignUp frame = new SignUp(l,user);
		...
		if (os == btnLogIn) {
			...
			if (u!= null) {
				...
				administrador=l.buscaruTrabajador(textFieldUsername.getText());
				
				Paneles paneles = new Paneles(l,administrador, user);
